...
class TestPicker(unittest.TestCase):
    def setUp(self):
        self.comment_picker = Picker("CommentGenerator/assets/templates.json")
        
    def test_pick_comment1(self):
        input1 = None
        with open("CommentGenerator/tests/mock_assets/elementary/pass/input1.json",'r') as mock_json:
    ...
    def test_pick_comment2(self):
        input2 = None
        with open("CommentGenerator/tests/mock_assets/elementary/pass/input2.json",'r') as mock_json:
