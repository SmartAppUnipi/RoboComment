...
def process_video(video_name, kb_response, user_id: str):
    # build args object
    args = {'video': f'data/videos/{video_name}', 'recompute': True,
            'no_show': True } # not saving video
    ...
    stream_to_symbolic(frames, user_id)
